...
gitmap merge-right ./gitmap-v12 https://github.com/alimtvnetwork/gitmap-v12 -y
...
```
  [mv] resolving LEFT  : ./gitmap-v12 (folder, exists)
  [mv] resolving RIGHT : https://github.com/alimtvnetwork/gitmap-v12
  [mv]   -> mapped to working folder: ./gitmap-v12
  [mv]   -> folder does not exist; cloning
  [mv]   -> clone OK (47 files, 1.2 MB)
  [mv] copying files LEFT -> RIGHT (excluding .git/) ...
  [mv]   copied 47 files
  [mv] deleting LEFT (./gitmap-v12) ...
  [mv]   deleted
  [mv] committing in RIGHT ...
  [mv]   commit 9a3c1e2 "gitmap mv from ./gitmap-v12"
  [mv] pushing RIGHT ...
  [mv]   push OK
  [mv] done
```
