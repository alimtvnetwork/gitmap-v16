...
Templates Phase 2+3+4 complete (v3.106.0+): `add ignore` / `add attributes` (sorted-tag marker blocks) plus `templates list --kind/--lang` filters. Pure `filterTemplates` helper for hermetic tests.
