...
```powershell
$ldflags = "-X 'github.com/alimtvnetwork/gitmap-v16/gitmap/constants.RepoPath=$absRepoRoot'"
...
```
  ...
  ──────────────────────────────────────────────────
  → Runner CWD: D:\wp-work\riseup-asia\gitmap-v16
  → Repo root: D:\wp-work\riseup-asia\gitmap-v16
...
| Repo root | Root of the gitmap-v16 project |
