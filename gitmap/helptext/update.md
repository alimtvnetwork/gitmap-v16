...
### Example 3: Update with custom repo path
    ...
    gitmap update --repo-path C:\Projects\gitmap-v12

**Output:**

    → Repo path: C:\Projects\gitmap-v12
    ■ Pulling latest source...
    ■ Building gitmap.exe...
    ✓ Updated to v2.49.1
...
**Output:**
    ...
    How to fix:
      ...
      Option 2 — Clone the repo and build from source:
        git clone https://github.com/.../gitmap-v12.git C:\gitmap-src
        cd C:\gitmap-src
        .\run.ps1

      Option 3 — Download the latest release manually:
        https://github.com/.../gitmap-v12/releases/latest
