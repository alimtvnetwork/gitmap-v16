...
**Scope:** Generic. Applies to any project whose repo name ends in a `-v<N>` suffix (e.g. `gitmap-v13`, `myapp-v7`, `cli-tool-v12`).
...
This guarantees a stale install URL (e.g. someone bookmarked `gitmap-v13` years ago) still pulls the user onto the latest major repo line without manual intervention.
...
| Input URL                                          | stem        | N  |
|----------------------------------------------------|-------------|----|
| `https://github.com/alimtvnetwork/gitmap-v13`       | `gitmap`    | 3  |
...
```
  [discovery] baseline: alimtvnetwork/gitmap-v13
  [discovery] probe ceiling: 30
  [discovery] HEAD https://github.com/alimtvnetwork/gitmap-v13 ... HIT
  [discovery] HEAD https://github.com/alimtvnetwork/gitmap-v13 ... MISS (fail-fast)
  [discovery] effective: alimtvnetwork/gitmap-v13
  [discovery] delegating to https://raw.githubusercontent.com/alimtvnetwork/gitmap-v13/main/install-quick.sh
```

The user transparently lands on `gitmap-v13` even though they invoked `gitmap-v13`.
