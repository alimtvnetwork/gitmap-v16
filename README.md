...
[![CI](https://github.com/alimtvnetwork/gitmap-v11/actions/workflows/ci.yml/badge.svg)](https://github.com/alimtvnetwork/gitmap-v11/actions/workflows/ci.yml)
[![golangci-lint](https://github.com/alimtvnetwork/gitmap-v11/actions/workflows/ci.yml/badge.svg?event=push)](https://github.com/alimtvnetwork/gitmap-v11/actions/workflows/ci.yml)
[![Vulncheck](https://github.com/alimtvnetwork/gitmap-v11/actions/workflows/vulncheck.yml/badge.svg)](https://github.com/alimtvnetwork/gitmap-v11/actions/workflows/vulncheck.yml)
[![GitHub Release](https://img.shields.io/github/v/release/alimtvnetwork/gitmap-v11?style=flat-square&label=version)](https://github.com/alimtvnetwork/gitmap-v11/releases)
[![Go](https://img.shields.io/badge/Go-1.23+-00ADD8?style=flat-square&logo=go&logoColor=white)](https://go.dev)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey?style=flat-square)](https://github.com/alimtvnetwork/gitmap-v11)
[![License](https://img.shields.io/badge/license-MIT-green?style=flat-square)](./LICENSE)
[![Go Report Card](https://goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v11/gitmap?style=flat-square)](https://goreportcard.com/report/github.com/alimtvnetwork/gitmap-v11/gitmap)
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/gitmap/scripts/install.ps1 | iex
```

### 🐧 macOS · Linux · Bash (latest)

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/gitmap/scripts/install.sh | sh
```
...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/release-version-v4.1.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/release-version-v4.1.0.sh | bash
```
...
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v4.1.0.ps1`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/release-version-v4.1.0.ps1) | [`gitmap-v4.1.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/gitmap-v4.1.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v4.1.0.sh`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/release-version-v4.1.0.sh) | [`gitmap-v4.1.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/gitmap-v4.1.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v4.1.0.sh`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/release-version-v4.1.0.sh) | [`gitmap-v4.1.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/gitmap-v4.1.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v4.1.0.sh`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/release-version-v4.1.0.sh) | [`gitmap-v4.1.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/gitmap-v4.1.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v4.1.0.sh`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/release-version-v4.1.0.sh) | [`gitmap-v4.1.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v11/releases/download/v4.1.0/gitmap-v4.1.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v11/releases/tag/v4.1.0](https://github.com/alimtvnetwork/gitmap-v11/releases/tag/v4.1.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
...
```powershell
# Windows · PowerShell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/install-quick.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/install-quick.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/uninstall-quick.ps1 | iex
```

#### Linux / macOS

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/uninstall-quick.sh | bash
```
...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/gitmap/scripts/install.ps1'))
```
...
1. **Use `--allow-fallback`** — Automatically picks the newest patch in the same
   ...
   ```powershell
   irm https://github.com/alimtvnetwork/gitmap-v11/releases/download/v3.38.0/release-version-v3.38.0.ps1 | iex
...
| Script | URL Pattern |
|--------|-------------|
| Pinned PowerShell | `https://github.com/alimtvnetwork/gitmap-v11/releases/download/{version}/release-version-{version}.ps1` |
| Pinned Bash | `https://github.com/alimtvnetwork/gitmap-v11/releases/download/{version}/release-version-{version}.sh` |
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/gitmap/scripts/install.ps1 | iex; Install-Gitmap -Version "v2.51.0"
```

**Specific version + custom directory (one-liner):**

```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/gitmap/scripts/install.ps1 | iex; Install-Gitmap -Version "v2.51.0" -InstallDir "D:\DevTools\gitmap"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/gitmap/scripts/install.sh | sh -s -- --version v2.51.0
```
...
```bash
git clone https://github.com/alimtvnetwork/gitmap-v11.git gitmap
```
...
gitmap clone https://github.com/alimtvnetwork/gitmap-v11
gitmap clone https://github.com/alimtvnetwork/gitmap-v11 my-folder
gitmap clone git@github.com:alimtvnetwork/gitmap-v11.git my-folder
gitmap clone https://github.com/alimtvnetwork/gitmap-v11 --replace   # see spec 96
...
gitmap mv ./gitmap-v11 ./gitmap-v11
gitmap mv ./gitmap-v11 https://github.com/alimtvnetwork/gitmap-v11
gitmap mv https://github.com/alimtvnetwork/gitmap-v11 ./another-folder
gitmap mv https://github.com/alimtvnetwork/gitmap-v11 \
         https://github.com/alimtvnetwork/gitmap-v11

# merge-both: bidirectional fill (each side gains what the other has)
gitmap merge-both ./gitmap-v11 ./gitmap-v11
gitmap merge-both ./gitmap-v11 https://github.com/alimtvnetwork/gitmap-v11
gitmap merge-both https://github.com/alimtvnetwork/gitmap-v11 \
                  https://github.com/alimtvnetwork/gitmap-v11

# merge-left: take RIGHT into LEFT
gitmap merge-left ./gitmap-v11 ./gitmap-v11
gitmap merge-left ./local https://github.com/alimtvnetwork/gitmap-v11

# merge-right: take LEFT into RIGHT
gitmap merge-right ./gitmap-v11 ./gitmap-v11
gitmap merge-right ./local https://github.com/alimtvnetwork/gitmap-v11

# bypass conflict prompts: source-side wins by default
gitmap merge-right ./gitmap-v11 ./gitmap-v11 -y
gitmap merge-both  ./gitmap-v11 ./gitmap-v11 -y --prefer-newer

# pin remote branch + preview
gitmap merge-right ./local https://github.com/owner/repo:develop
gitmap mv ./gitmap-v11 ./gitmap-v11 --dry-run
```
...
$ver = 'v3.50.0'
$installer = irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/gitmap/scripts/install.ps1
& ([scriptblock]::Create($installer)) -Version $ver -NoDiscovery
```

```bash
# Linux / macOS — install v3.50.0 exactly
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v11/main/gitmap/scripts/install.sh \
...
- 🐛 **Fixes:** README badge now points at `goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v11/gitmap` (real module path) instead of the repo root, which 404'd because there is no `go.mod` at the root.
...
- 💥 **Breaking:** `go.mod` module path renamed from a placeholder to `github.com/alimtvnetwork/gitmap-v11/gitmap`. Anyone importing the module by the old path must update their import lines. CLI users are unaffected.
...
> Versions older than v3.22 are summarized in [`CHANGELOG.md`](CHANGELOG.md). Notable jumps: **v3.21** (schema-version fast path + `db-migrate --force`), **v3.19** (bare release auto-bumps **minor** + multi-repo scan-dir release), **v3.17** (`Release.RepoId` foreign key + doctor duplicate-binary check), **v3.16** (repo renamed to `gitmap-v11`).
...
[
  ...
  {
    "repoName": "gitmap-v11",
    "httpsUrl": "https://github.com/alimtvnetwork/gitmap-v11.git",
    "relativePath": "gitmap-v11",
    "depth": 1
  }
]
```
...
gitmap-v11,git@github.com:alimtvnetwork/gitmap-v11.git,,gitmap-v11
```
