...
**Example:** `git@github.com:alimtvnetwork/gitmap-v7.git`
→ `slug = "gitmap-v7"` → `base = "gitmap"`, `K = 7`.
...
replace: src/foo.go: 3 matches (gitmap-v4 → gitmap-v7)
replace: docs/setup.md: 1 match (gitmap-v5 → gitmap-v7)
...
