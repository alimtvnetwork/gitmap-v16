...
func TestSlugFromRemote(t *testing.T) {
	cases := map[string]string{
		"https://github.com/alimtvnetwork/gitmap-v11.git": "gitmap-v11",
		"https://github.com/alimtvnetwork/gitmap-v11":     "gitmap-v11",
		"git@github.com:alimtvnetwork/gitmap-v11.git":     "gitmap-v11",
		"git@github.com:alimtvnetwork/gitmap-v11":         "gitmap-v11",
...
func TestPairsForTarget(t *testing.T) {
	...
	if got[0].old != "gitmap-v4" || got[0].new != "gitmap-v11" {
