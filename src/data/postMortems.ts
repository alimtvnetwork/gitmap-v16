...
export const postMortems: PostMortemEntry[] = [
  ...
  },
  {
    ...
    summary: "PowerShell progress bar crashed terminal during irm | iex. Versioned binary names (e.g., gitmap-v16.54.6-windows-amd64.exe) were not detected. Fixed with $ProgressPreference, regex matching, and top-level try/catch.",
    version: "v2.55.0",
    category: "general",
  },
  {
