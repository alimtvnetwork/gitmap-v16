...
**Example:** `git@github.com:alimtvnetwork/gitmap-v11.git`
→ `slug = "gitmap-v11"` → `base = "gitmap"`, `K = 7`.
...
replace: src/foo.go: 3 matches (gitmap-v4 → gitmap-v11)
replace: docs/setup.md: 1 match (gitmap-v11 → gitmap-v11)
...
