...
```powershell
$ldflags = "-X 'github.com/alimtvnetwork/gitmap-v13/gitmap/constants.RepoPath=$absRepoRoot'"
...
```
  ...
  ──────────────────────────────────────────────────
  → Runner CWD: D:\wp-work\riseup-asia\gitmap-v13
  → Repo root: D:\wp-work\riseup-asia\gitmap-v13
...
| Repo root | Root of the gitmap-v13 project |
