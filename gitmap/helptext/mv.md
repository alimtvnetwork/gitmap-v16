...
**Output:**
    ...
    [mv] resolving LEFT : ./gitmap-v11 (folder)
    [mv] resolving RIGHT : ./gitmap-v11 (folder)
...
**Output:**
    ...
    [mv] resolving RIGHT : https://github.com/owner/gitmap-v11
    [mv]   -> mapped to working folder: /work/gitmap-v11
    [mv]   -> folder does not exist; cloning
    [mv]   -> clone OK
    [mv] copying files LEFT -> RIGHT (excluding .git/) ...
    [mv]   copied 142 files
    [mv] committing in https://github.com/owner/gitmap-v11 ...
    [mv]   commit a1b2c3d "gitmap mv from ./gitmap-v11"
    [mv] pushing https://github.com/owner/gitmap-v11 ...
    [mv]   push OK
    [mv] done
