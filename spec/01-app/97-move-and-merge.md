...
gitmap merge-right ./gitmap-v13 https://github.com/alimtvnetwork/gitmap-v13 -y
...
```
  [mv] resolving LEFT  : ./gitmap-v13 (folder, exists)
  [mv] resolving RIGHT : https://github.com/alimtvnetwork/gitmap-v13
  [mv]   -> mapped to working folder: ./gitmap-v13
  [mv]   -> folder does not exist; cloning
  [mv]   -> clone OK (47 files, 1.2 MB)
  [mv] copying files LEFT -> RIGHT (excluding .git/) ...
  [mv]   copied 47 files
  [mv] deleting LEFT (./gitmap-v13) ...
  [mv]   deleted
  [mv] committing in RIGHT ...
  [mv]   commit 9a3c1e2 "gitmap mv from ./gitmap-v13"
  [mv] pushing RIGHT ...
  [mv]   push OK
  [mv] done
```
