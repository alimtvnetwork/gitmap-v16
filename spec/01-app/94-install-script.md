...
| Field       | Value                                              |
|-------------|----------------------------------------------------|
| GitHub Repo | `alimtvnetwork/gitmap-v16`                 |
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v16/main/gitmap/scripts/install.sh | bash
```

### Version-Pinned

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v16/main/gitmap/scripts/install.sh | bash -s -- --version v2.55.0
```

### Custom Directory

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v16/main/gitmap/scripts/install.sh | bash -s -- --dir /opt/gitmap --version v2.55.0
```
...
7. Extract archive to temp directory; search for binary using 4-priority
   ...
   (e.g., `gitmap-v16.55.0-linux-amd64`) → any executable.
