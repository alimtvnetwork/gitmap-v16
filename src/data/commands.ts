...
export const commands: CommandDef[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    examples: [
      { command: "gitmap mv ./gitmap-v13 ./gitmap-v13", description: "Move local folder into another local folder, deleting source" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap merge-both ./gitmap-v13 ./gitmap-v13", description: "Interactive two-way merge between two local folders" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap merge-left ./gitmap-v13 ./gitmap-v13", description: "Pull RIGHT's changes into LEFT (interactive prompt)" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap diff ./gitmap-v13 ./gitmap-v13", description: "Plain text diff of two local folders" },
