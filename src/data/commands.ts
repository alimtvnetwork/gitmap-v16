...
export const commands: CommandDef[] = [
  ...
  {
    category: "release",
    name: "release-pull", alias: "relp", description: "Sugar for `release` that first runs `git pull --ff-only` in the current repo, then delegates to the standard release pipeline. Hard-fails on non-fast-forward so we never tag on top of a divergent tree.",
    usage: "gitmap release-pull [version] [release flags...]",
    flags: [
      ...
      { flag: "--dry-run", description: "Forwarded to release: preview without tagging or pushing" },
      { flag: "-y, --yes", description: "Forwarded to release: skip confirmation prompts" },
    ],
    examples: [
      { command: "gitmap release-pull v1.4.0", description: "Fast-forward pull, then release v1.4.0" },
      { command: "gitmap relp", description: "Pull then release with auto-bump prompt" },
      { command: "gitmap relp v2.0.0 --bin --draft", description: "Pull, build binaries, push as draft" },
      { command: "gitmap relp --dry-run", description: "Pull then preview the release plan" },
    ],
    seeAlso: [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    examples: [
      { command: "gitmap mv ./gitmap-v11 ./gitmap-v11", description: "Move local folder into another local folder, deleting source" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap merge-both ./gitmap-v11 ./gitmap-v11", description: "Interactive two-way merge between two local folders" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap merge-left ./gitmap-v11 ./gitmap-v11", description: "Pull RIGHT's changes into LEFT (interactive prompt)" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap diff ./gitmap-v11 ./gitmap-v11", description: "Plain text diff of two local folders" },
