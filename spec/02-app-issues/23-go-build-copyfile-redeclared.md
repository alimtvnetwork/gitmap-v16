...
cmd/installvscode.go:11:2: "github.com/alimtvnetwork/gitmap-v16/gitmap/constants" imported and not used
```
...
`installvscode.go` imported `github.com/alimtvnetwork/gitmap-v16/gitmap/constants` but never
