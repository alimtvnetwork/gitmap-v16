...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Renamed `gitmap-v3` → `gitmap-v12` across Go constants, install/uninstall scripts, spec docs, helptext, README, React data files, and GitHub workflows. Only `.gitmap/` artifacts retain v3 references (immutable per project policy).",
  ...
  },
  {
    ...
    items: [
      ...
      "Fixed `gitmap/store/migrations.go` build error caused by an orphan `\"github.com/alimtvnetwork/gitmap-v12/gitmap/constants\"` import.",
  ...
  },
  {
    ...
    items: [
      ...
      "Repository renamed from `git-repo-navigator` to `gitmap-v12`.",
    ],
  },
  {
    version: "v2.51.0",
