...
[![golangci-lint](https://github.com/alimtvnetwork/gitmap-v9/actions/workflows/ci.yml/badge.svg?event=push)](https://github.com/alimtvnetwork/gitmap-v9/actions/workflows/ci.yml)
[![Vulncheck](https://github.com/alimtvnetwork/gitmap-v9/actions/workflows/vulncheck.yml/badge.svg)](https://github.com/alimtvnetwork/gitmap-v9/actions/workflows/vulncheck.yml)
[![GitHub Release](https://img.shields.io/github/v/release/alimtvnetwork/gitmap-v9?style=flat-square&label=version)](https://github.com/alimtvnetwork/gitmap-v9/releases)
[![Go](https://img.shields.io/badge/Go-1.23+-00ADD8?style=flat-square&logo=go&logoColor=white)](https://go.dev)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey?style=flat-square)](https://github.com/alimtvnetwork/gitmap-v9)
[![License](https://img.shields.io/badge/license-MIT-green?style=flat-square)](./LICENSE)
[![Go Report Card](https://goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v9/gitmap?style=flat-square)](https://goreportcard.com/report/github.com/alimtvnetwork/gitmap-v9/gitmap)
...
| Script | URL Pattern |
|--------|-------------|
| Pinned PowerShell | `https://github.com/alimtvnetwork/gitmap-v9/releases/download/{version}/release-version-{version}.ps1` |
| Pinned Bash | `https://github.com/alimtvnetwork/gitmap-v9/releases/download/{version}/release-version-{version}.sh` |
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v9/main/gitmap/scripts/install.ps1 | iex; Install-Gitmap -Version "v2.51.0"
```

**Specific version + custom directory (one-liner):**

```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v9/main/gitmap/scripts/install.ps1 | iex; Install-Gitmap -Version "v2.51.0" -InstallDir "D:\DevTools\gitmap"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v9/main/gitmap/scripts/install.sh | sh -s -- --version v2.51.0
```
...
gitmap clone https://github.com/alimtvnetwork/gitmap-v9
gitmap clone https://github.com/alimtvnetwork/gitmap-v9 my-folder
gitmap clone git@github.com:alimtvnetwork/gitmap-v9.git my-folder
gitmap clone https://github.com/alimtvnetwork/gitmap-v9 --replace   # see spec 96
...
gitmap merge-both https://github.com/alimtvnetwork/gitmap-v9 \
                  https://github.com/alimtvnetwork/gitmap-v9

# merge-left: take RIGHT into LEFT
gitmap merge-left ./gitmap-v9 ./gitmap-v9
gitmap merge-left ./local https://github.com/alimtvnetwork/gitmap-v9

# merge-right: take LEFT into RIGHT
gitmap merge-right ./gitmap-v9 ./gitmap-v9
gitmap merge-right ./local https://github.com/alimtvnetwork/gitmap-v9

# bypass conflict prompts: source-side wins by default
gitmap merge-right ./gitmap-v9 ./gitmap-v9 -y
gitmap merge-both  ./gitmap-v9 ./gitmap-v9 -y --prefer-newer
...
- 🐛 **Fixes:** README badge now points at `goreportcard.com/badge/github.com/alimtvnetwork/gitmap-v9/gitmap` (real module path) instead of the repo root, which 404'd because there is no `go.mod` at the root.
...
- 💥 **Breaking:** `go.mod` module path renamed from a placeholder to `github.com/alimtvnetwork/gitmap-v9/gitmap`. Anyone importing the module by the old path must update their import lines. CLI users are unaffected.
...
> Versions older than v3.22 are summarized in [`CHANGELOG.md`](CHANGELOG.md). Notable jumps: **v3.21** (schema-version fast path + `db-migrate --force`), **v3.19** (bare release auto-bumps **minor** + multi-repo scan-dir release), **v3.17** (`Release.RepoId` foreign key + doctor duplicate-binary check), **v3.16** (repo renamed to `gitmap-v9`).
...
[
  ...
  {
    "repoName": "gitmap-v9",
    "httpsUrl": "https://github.com/alimtvnetwork/gitmap-v9.git",
    "relativePath": "gitmap-v9",
    "depth": 1
  }
]
```
...
gitmap-v9,git@github.com:alimtvnetwork/gitmap-v9.git,,gitmap-v9
```
