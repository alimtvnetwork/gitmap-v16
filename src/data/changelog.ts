...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      "Closed a long-standing test desync in `gitmap/cmd/replaceversionparse_test.go::TestPairsForTarget` and `gitmap/cmd/replaceaudit_test.go::TestBuildAuditNeedles`. Both tests passed `current=9` (or implied a 1-digit current) into the function under test, but their hard-coded `want` slices included the literal string `\"gitmap-v16\"` next to a `\"gitmap/v9\"` neighbor — an internally contradictory expectation that drifted whenever the project's own version was bumped past v9. After every width-crossing release the same 4-line edit had to be re-applied by hand; if the edit was missed, the test silently locked in the wrong contract.",
  ...
  },
  {
    ...
    items: [
      ...
      "Renamed `gitmap-v16` → `gitmap-v16` across Go constants, install/uninstall scripts, spec docs, helptext, README, React data files, and GitHub workflows. Only `.gitmap/` artifacts retain v3 references (immutable per project policy).",
  ...
  },
  {
    ...
    items: [
      ...
      "Fixed `gitmap/store/migrations.go` build error caused by an orphan `\"github.com/alimtvnetwork/gitmap-v16/gitmap/constants\"` import.",
  ...
  },
  {
    ...
    items: [
      ...
      "Repository renamed from `git-repo-navigator` to `gitmap-v16`.",
    ],
  },
  {
    version: "v2.51.0",
