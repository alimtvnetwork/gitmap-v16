...
```powershell
$ldflags = "-X 'github.com/alimtvnetwork/gitmap-v12/gitmap/constants.RepoPath=$absRepoRoot'"
...
```
  ...
  ──────────────────────────────────────────────────
  → Runner CWD: D:\wp-work\riseup-asia\gitmap-v12
  → Repo root: D:\wp-work\riseup-asia\gitmap-v12
...
| Repo root | Root of the gitmap-v12 project |
