...
export const commands: CommandDef[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    examples: [
      { command: "gitmap mv ./gitmap-v16 ./gitmap-v16", description: "Move local folder into another local folder, deleting source" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap merge-both ./gitmap-v16 ./gitmap-v16", description: "Interactive two-way merge between two local folders" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap merge-left ./gitmap-v16 ./gitmap-v16", description: "Pull RIGHT's changes into LEFT (interactive prompt)" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap diff ./gitmap-v16 ./gitmap-v16", description: "Plain text diff of two local folders" },
