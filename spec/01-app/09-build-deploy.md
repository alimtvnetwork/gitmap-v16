...
```powershell
$ldflags = "-X 'github.com/alimtvnetwork/gitmap-v11/gitmap/constants.RepoPath=$absRepoRoot'"
...
```
  ...
  ──────────────────────────────────────────────────
  → Runner CWD: D:\wp-work\riseup-asia\gitmap-v11
  → Repo root: D:\wp-work\riseup-asia\gitmap-v11
...
| Repo root | Root of the gitmap-v11 project |
