...
const (
	...
	// (e.g. gitmap-v16/v6/v7) and exits non-zero on any hit. Used as a // gitmap-legacy-ref-allow
...
// Defaults catch the gitmap-v16/v6/v7 → v8 rename regression class. // gitmap-legacy-ref-allow
const (
	...
	DefaultAuditLegacyReplace   = "gitmap-v16"
