...
### Version bump (`-3` on a `gitmap-v13` repo)

```
$ gitmap replace -3

  replace: scanning 412 files in /repo
  replace: go.mod: 1 match (gitmap-v4 -> gitmap-v13)
  replace: docs/upgrade.md: 4 matches (gitmap-v13 -> gitmap-v13)
...
$ gitmap replace --audit
  ...
  README.md:42: see https://github.com/x/gitmap-v13 for the legacy guide
  go.mod:3: module github.com/x/gitmap-v13
```
