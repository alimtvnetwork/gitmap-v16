...
gitmap merge-right ./gitmap-v11 https://github.com/alimtvnetwork/gitmap-v11 -y
...
```
  [mv] resolving LEFT  : ./gitmap-v11 (folder, exists)
  [mv] resolving RIGHT : https://github.com/alimtvnetwork/gitmap-v11
  [mv]   -> mapped to working folder: ./gitmap-v11
  [mv]   -> folder does not exist; cloning
  [mv]   -> clone OK (47 files, 1.2 MB)
  [mv] copying files LEFT -> RIGHT (excluding .git/) ...
  [mv]   copied 47 files
  [mv] deleting LEFT (./gitmap-v11) ...
  [mv]   deleted
  [mv] committing in RIGHT ...
  [mv]   commit 9a3c1e2 "gitmap mv from ./gitmap-v11"
  [mv] pushing RIGHT ...
  [mv]   push OK
  [mv] done
```
